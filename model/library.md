...
| Book               | EntityType                            | PageCount: Int16, AgeRating: Byte, PublisherId: Int32, Nav. `Publisher` → `PublisherRegistry.Publisher` (Partner of Publisher.`Books`, **ReferentialConstraint** PublisherId → Id)                                                           | PrintMedium | no       | no      |
